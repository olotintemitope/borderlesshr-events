...
<div class="container-fluid">
    <div class="row">
        <div class="col-6 mx-auto mt-5">
            <h2 class="mt-5 mb-5">Edit Event Type</h2>

            <?php include_once $viewPath . 'flash/messages.php' ?>

            <div class="card">
                <div class="card-body">
                    <form method="post" action="/admin/event-type/update/<?php echo $eventType['id'];?>" enctype="application/x-www-form-urlencoded">
                        <div class="mb-3">
                            <label for="email" class="form-label">Type</label>
                            <input type="text" name="type" class="form-control" id="type" required value="<?php echo $eventType['type'];?>"/>
                        </div>
                        <div class="mb-3">
